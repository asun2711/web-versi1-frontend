<template>
  <div class="page-wrapper">
    ...
    <div class="two-columns">
      <!-- IGD List -->
      <section v-if="activeTab === 'IGD'" class="pengumuman-list">
        ...
        >
          <div class="meta-row">
            <span class="meta-item">🚨 IGD</span>
          </div>

          <h2 class="judul-pengumuman">{{ item.namaigd }}</h2>
          ...
          <div class="content-wrapper">
            <div class="content-row">
              <img
                ...
                decoding="async"
              />
              <p class="pengumuman-desc">{{ item.isiigd }}</p>
            </div>

            <div class="btn-wrapper">
              <button
                class="btn-readmore"
                @click.stop="goToDetail('igd', item.id)"
              >
                Baca Selengkapnya
              </button>
            </div>
