  ...
  setup() {
    ...
    const imageSrc = computed(() => {
      ...
      if ((detail.value as any).gambarrawatjalan)
        return `${API_URL}/uploads/rawatjalan/${(detail.value as any).gambarrawatjalan}`;
      if ((detail.value as any).gambarrawatinap)
        return `${API_URL}/uploads/rawatinap/${(detail.value as any).gambarrawatinap}`;
      if ((detail.value as any).gambarigd)
        return `${API_URL}/uploads/igd/${(detail.value as any).gambarigd}`;
      return null;
    });
