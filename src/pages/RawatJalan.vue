<template>
  <div class="page-wrapper">
    ...
    <div class="two-columns">
      ...
      <!-- Rawat Jalan List -->
      <section v-if="activeTab === 'Rawat Jalan'" class="pengumuman-list">
        ...
        >
          ...
          <h2 class="judul-pengumuman">{{ item.namarawatjalan }}</h2>
...
export default defineComponent({
  ...
  setup() {
    ...
    const activeTab = computed(() => {
      ...
      return found ? found.name : 'Rawat Jalan';
    });
